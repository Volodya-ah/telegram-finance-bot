...
def get_main_menu_text() -> str:
    return (
        ...
        "➕ Добавить подстатьи — добавить новые подстатьи в существующую статью\n"
...
async def categories_handler(message: Message) -> None:
    ...
    try:
        ...
        text += (
            "Чтобы добавить расход, используйте подстатью:\n"
            "25 000 Реклама май"
        )
...
async def help_handler(message: Message) -> None:
    ...
    await message.answer(
       "Как добавить расход:\n\n"
       "Напишите сумму и подстатью:\n"
       "25 000 Реклама май\n"
       "10 000 Аренда офиса\n"
       "1500 Кофе встреча с клиентом\n\n"
       "Можно добавить несколько расходов одним сообщением:\n"
       "1200 Связь май\n"
       "3000 Хостинг сайт\n\n"
       "Важно:\n"
       "- сумма должна быть в начале строки\n"
       "- подстатья должна совпадать с одной из подстатей в таблице\n"
       "- комментарий можно писать после подстатьи\n\n"
       "Команды:\n"
       "/start — запуск бота\n"
       "/menu — главное меню\n"
       "/categories — список доступных статей и подстатей\n"
       "/add_subcategories — добавить подстатьи\n"
